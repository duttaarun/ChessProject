...
public class Pawn {
	...
	public void move(MovementType movementType, int newX, int newY) {
		if (movementType.equals(MovementType.MOVE)) {
			if ((this.getXCoordinate() - 1 == newX && this.getYCoordinate() == newY
					&& this.pieceColor.equals(PieceColor.BLACK))
					|| (this.getXCoordinate() + 1 == newX && this.getYCoordinate() == newY
							&& this.pieceColor.equals(PieceColor.WHITE))) {
